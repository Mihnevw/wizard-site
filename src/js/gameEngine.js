...
function gameLoop(state, game, timestamp) {
    ...
    if (state.keys.Space) {
        game.wizardElement.style.backgroundImage = 'url("/wizard-fire.png")';
        ...
        game.wizardElement.style.backgroundImage = 'url("/wizard.png")';
    }
    ...
    if (timestamp > state.bugStats.nextSpawnTimestamp) {
        ...
        state.bugStats.nextSpawnTimestamp = timestamp + Math.random() * state.bugStats.maxSpawnInterval;//Така казваме че искаме следващия път да се случи текущия timespan събран с Math random умножен по 3000
    }
